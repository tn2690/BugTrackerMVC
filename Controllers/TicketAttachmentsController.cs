...
namespace BugTrackerMVC.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,FileData,FileType,FileName,TicketId,BTUserId")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Created,FileData,FileType,FileName,TicketId,BTUserId")] TicketAttachment ticketAttachment)
        {
